...
import { get_pontuados_api, status_mercado_fechado, get_atletas_api } from "../pages";
...
export class JogadoresControll implements IJogadoresControll {
    ...
    private atletasDoMercado: Atleta[];
    ...
    loadJogadores() {
        return new Promise((resolve, reject) => {
            if (this.needsUpdateAtletas()) {
                ...
                console.log("Não precisa atualizar os jogadores");
                resolve(true);
            }
        });
    }
    ...
    getJogadoresDoMercado() {
        return new Promise((resolve, reject) => {
            if (typeof this.atletasDoMercado == 'undefined') {
                this.loadJogadoresDoMercado().then(res => {
                    if (res) {
                        resolve(this.atletasDoMercado);
                    }
                });
            } else {
                resolve(this.atletasDoMercado);
